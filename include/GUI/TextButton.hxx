...
namespace gui
{
    ...
    class TextButton : public Button
    {
      ...
      public:
         ...
         *
         * This constructor initializes a TextButton with a given position, size, fill color, text, font, character
         * size, and text color. Optionally, the button's outline thickness and outline color can also be specified.
         *
         ...
         */
        TextButton(const sf::Vector2f position, const sf::Vector2f size, const sf::Color fill_color,
                   const std::string str, const sf::Font &font, const unsigned int char_size,
                   const sf::Color text_color = sf::Color::White, const float outline_thickness = 0.f,
