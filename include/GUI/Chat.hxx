      ...
      private:
        ...
        class Message
        {
          public:
             ...
             */
            Message(const std::string &author, const std::string &content, const sf::Vector2f &position,
                    const float &width, const float &padding, sf::Font &font, const unsigned int &char_size,
